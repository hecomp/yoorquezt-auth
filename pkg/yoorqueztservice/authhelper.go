...
//}
//
//func (auth *AuthHelper) UpdateUserVerificationStatus(ctx context.Context, email string, status bool) error {
//	panic("implement me")
//}
//
//func (auth *AuthHelper) DeleteVerificationData(ctx context.Context, email string, verificationDataType data.VerificationDataType) error {
//	panic("implement me")
//}
//
//func NewHelper(logger log.Logger, mailService mail2.MailService, validator *data.Validation, repository *signup.Repository, configs *utils.Configurations) helper.IAuthHelper {
//	return &AuthHelper{
//		logger:      logger,
