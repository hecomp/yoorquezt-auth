...
func (i instrumentingService) Signup(ctx context.Context, user *data.User) error {
...
func (i instrumentingService) Login(ctx context.Context, user *data.User) (*data.User, error) {
	defer func(begin time.Time) {
...
func (i instrumentingService) VerifyMail(ctx context.Context, verificationData *data.VerificationData) (*data.VerificationData, error) {
	defer func(begin time.Time) {
